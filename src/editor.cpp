...
// (LPVOID*)&pBackBuffer); 	g_pd3dDevice->CreateRenderTargetView(pBackBuffer,
// &render_target_view_desc, &g_mainRenderTargetView);
// 	g_pd3dDeviceContext->OMSetRenderTargets(1, &g_mainRenderTargetView,
// NULL); 	pBackBuffer->Release();
// }
//
...
// g_pd3dDeviceContext = NULL; } 	if (g_pd3dDevice) { g_pd3dDevice->Release();
// g_pd3dDevice = NULL; }
// }
//
// //extern LRESULT ImGui_ImplDX11_WndProcHandler(HWND hWnd, UINT msg, WPARAM
// wParam, LPARAM lParam); LRESULT WINAPI WndProc(HWND hWnd, UINT msg, WPARAM
...
// 		return 0;
// 	case WM_SYSCOMMAND:
// 		if ((wParam & 0xfff0) == SC_KEYMENU) // Disable ALT application
// menu 			return 0; 		break; 	case WM_DESTROY: 		PostQuitMessage(0); 		return 0;
// 	}
